...
public class GameFormPanel extends JPanel {
	...
	private GameFormFieldsPanel gameFormFieldsPanel;
	...
	private void initializeComponents() { 
		...
		gameFormFieldsPanel = new GameFormFieldsPanel();
		gameFormFieldsPanel.setBorder(new EmptyBorder(0, 20, 0, 20)); 
		...
		add(gameFormFieldsPanel, BorderLayout.CENTER);
	...
	public GameFormFieldsPanel getGameFormFieldsPanel() {
		return gameFormFieldsPanel;
	}

	public void setGameFormFieldsPanel(GameFormFieldsPanel gameFormFieldsPanel) {
		this.gameFormFieldsPanel = gameFormFieldsPanel;
	}
