...
public class PlayerCardPanel extends BaseCardPanel {
	...
	protected void buildInfo() {
		...
		infoPanel.add(experienceLevelLabel);
	}
	...
	public JLabel getExperienceLevelLabel() {
		return experienceLevelLabel;
	}

	public void setExperienceLevelLabel(JLabel experienceLevelLabel) {
		this.experienceLevelLabel = experienceLevelLabel;
	}
